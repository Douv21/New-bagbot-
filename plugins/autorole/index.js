        ...
        try {
            ...
            if (mode === 'embed') {
                const embed = new EmbedBuilder()
                    .setTitle(title || "Sélection du rôle")
                ...
                options.content = content || `Obtenez le rôle **${role.name}** ici !`;
            }
            ...
            if (displayType === 'select') {
                row.addComponents(new StringSelectMenuBuilder().setCustomId(cid).setPlaceholder("Choisir un rôle...").addOptions([{ label: role.name, value: roleId }]));
            } else {

...
<head>
    ...
    <style>
        ...
        .nav-item { padding: 20px; display: flex; align-items: center; color: #888; cursor: pointer; white-space: nowrap; }
        ...
        @media (max-width: 768px) {
            ...
            .nav-item { border-left: none; padding: 15px; }
            .nav-item.active { border-bottom: 3px solid var(--accent); }
        }
    </style>
</head>
<body>
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-item">🛡️ <span class="nav-text">Modération</span></div>
    </div>
    <div class="content">
        <div class="card">
            <h1>Rôles-Réactions</h1>
            <label>Nom du panneau</label>
            <input type="text" id="title" placeholder="Ex: Rôles Jeux">
            <label>Salon Discord</label>
            <select id="channels"><option>Chargement...</option></select>
            <label>Rôle à donner</label>
